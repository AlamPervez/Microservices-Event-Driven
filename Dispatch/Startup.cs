...
using Dispatch.IntegrationEvents.Handlers;
...
namespace Dispatch
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            eventBus.SubscribeAsync<InvoiceProcessedIntegrationEvent, InvoiceProcessedIntegrationEventHandler>();
        }
    }
    ...
    public static class ServiceCollectionExtension
    {
        public static IServiceCollection RegisterEntities(this IServiceCollection services, string databaseConnectionString)
        {
            ...
            services.AddTransient<InvoiceProcessedIntegrationEventHandler>();
            return services;
        }
        ...
        public static IServiceCollection AddCustomSwagger(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                options.SwaggerDoc("v1", new Swashbuckle.AspNetCore.Swagger.Info
                {
                    Title = "Dispatch API",
                    Version = "v1",
                    Description = "Dispatch API Documentation",
